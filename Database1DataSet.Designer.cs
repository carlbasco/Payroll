...
namespace Payroll_System {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public employeeRow AddemployeeRow(string id, string firstName, string middleName, string lastname) {
            ...
            private void InitClass() {
                ...
                this.columnmiddleName.MaxLength = 250;
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[employee] WHERE (([id] = @Original_id) AND ([firstName] = @Ori" +
                "ginal_firstName) AND ((@IsNull_middleName = 1 AND [middleName] IS NULL) OR ([mid" +
                "dleName] = @Original_middleName)) AND ([lastname] = @Original_lastname))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employee] SET [id] = @id, [firstName] = @firstName, [middleName] = @middleName, [lastname] = @lastname WHERE (([id] = @Original_id) AND ([firstName] = @Original_firstName) AND ((@IsNull_middleName = 1 AND [middleName] IS NULL) OR ([middleName] = @Original_middleName)) AND ([lastname] = @Original_lastname));
SELECT id, firstName, middleName, lastname FROM employee WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, firstName, middleName, lastname FROM dbo.employee";
        ...
        public virtual int Delete(string Original_id, string Original_firstName, string Original_middleName, string Original_lastname) {
            if ((Original_id == null)) {
        ...
        public virtual int Update(string id, string firstName, string middleName, string lastname, string Original_id, string Original_firstName, string Original_middleName, string Original_lastname) {
            if ((id == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string middleName, string lastname, string Original_id, string Original_firstName, string Original_middleName, string Original_lastname) {
            return this.Update(Original_id, firstName, middleName, lastname, Original_id, Original_firstName, Original_middleName, Original_lastname);
        }
    }
